...
const PlaceOrderScreen = ({ history }) => {
  ...
  //Dùng useSelector để lấy state của userLogin từ trong store
  ...
  cart.shippingPrice = addDecimals(cart.itemsPrice > 100 ? 5000 : 100000);
  cart.taxPrice = addDecimals(Number((0 * cart.itemsPrice).toFixed()));
  cart.totalPrice = (
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>Giao đến: {cart.shippingAddress.city}</p>
